...
// This should match the templates from the main designs route
...
export async function POST(request: Request) {
  try {
    ...
    // For now, we'll use a simple template lookup
    // In a real implementation, you'd fetch from the same source as the main route
